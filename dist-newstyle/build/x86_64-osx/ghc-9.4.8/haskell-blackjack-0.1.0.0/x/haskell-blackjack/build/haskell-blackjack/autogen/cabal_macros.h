...
/* package haskell-blackjack-0.1.0.0 */
#ifndef VERSION_haskell_blackjack
#define VERSION_haskell_blackjack "0.1.0.0"
#endif /* VERSION_haskell_blackjack */
#ifndef MIN_VERSION_haskell_blackjack
#define MIN_VERSION_haskell_blackjack(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_blackjack */
...
#define CURRENT_COMPONENT_ID "haskell-blackjack-0.1.0.0-inplace-haskell-blackjack"
